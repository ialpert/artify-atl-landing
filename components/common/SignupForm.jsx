      ...
      <div className="row">
        ...
        <div className="col-12">
          <div className="input-group-meta mb-25">
            ...
            <input type={showPassword ? 'text' : 'password'} placeholder="Password" className="pass_log_id" required />
          ...
          <div className="agreement-checkbox d-flex justify-content-between align-items-center">
            <div>
              ...
              <label htmlFor="agree_to_policy">
                By clicking &quot;SIGN UP&quot; I agree to the Terms and Conditions and Privacy Policy.
              </label>
            </div>
          </div>
          {/* /.agreement-checkbox */}
        ...
        <div className="col-12">
          <button className="btn-twentyTwo w-100 fw-500 tran3s text-uppercase mt-30">Sign Up</button>
        </div>
        {/* End .col-12 */}
      </div>
    </form>

  ...
  return (
    <>
      {cardsData.map((card, index) => (
        <div key={index} className="col-lg-3 col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay={card.delay}>
          <div className="card-style-two mt-40">
            <div className="icon d-flex align-items-end">
              <img src={card.icon} alt="" className="lazy-img" />
            </div>
            <span className="d-inline-block text-uppercase fs-14 opacity-75 mt-30 mb-10">{card.title}</span>

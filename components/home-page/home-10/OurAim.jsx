  ...
  const aimItems = [
    {
      ...
      list: ['Amazing communication.', 'Best trending designing experience.', 'Email & Live chat.'],
    ...
    <div className="row">
      <div className="col-lg-5 col-md-6 ms-auto order-md-last">
        {aimItems.map((item, index) => (
          <div className="block-style-one pt-35" data-aos="fade-left" key={index}>
        ...
        <Link href="/pages-menu/about-us-v1" className="more-btn tran3s fw-500 fs-18" data-aos="fade-left">
        ...
        <div className="img-meta d-inline-block position-relative ps-3 ps-lg-5 pb-50 md-mt-50 sm-mt-80">
          ...
          <div className="card-one" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="name fs-18 fw-500 tx-dark mb-10">
              - {cardItem.name}, <span className="opacity-50">{cardItem.position}</span>
            </div>

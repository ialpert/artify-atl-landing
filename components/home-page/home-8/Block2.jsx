...
const Block2 = () => {
  ...
  return (
    <>
      {data.map((item, index) => (
        <div key={index} className={`col-lg-4 col-md-6 ${index === 1 ? 'active' : ''}`}>
          <div
          ...
          >
            <div className="icon d-flex align-items-center justify-content-center">
              <Image width={180} height={180} layout="intrinsic" src={item.icon} alt="shape" className="lazy-img" />
            </div>
            ...
            <a href="#" className="arrow tran3s">
              <img src="/images/icon/icon_80.svg" alt="shape" className="lazy-img" />
            </a>
          </div>
          {/* /.card-style-twelve */}
        </div>

...
const Hero = () => {
  ...
  return (
    <>
      <ModalVideo channel="youtube" autoplay isOpen={isOpen} videoId="Vsq1_kewchQ" onClose={() => setOpen(false)} />
      ...
      <div className="d-sm-flex align-items-center">
        ...
        >
          ...
          <div className="ps-3">
            ...
            <strong className="fs-18 fw-500 text-white d-block">Intro Video</strong>
          </div>
        </div>
        {/* End popup video */}

        <Link href="#" className="btn-sixteen fw-500 tran3s mb-25 me-4 order-sm-first">
          Start Trading
        </Link>
      </div>
      <h2 className="fw-500 text-white mt-60 lg-mt-30 mb-5">A+ Rating</h2>
      <p className="fs-20 opacity-50 text-white">Avg rating 4.8 makes us world most best apps.</p>
    </>
  );
};

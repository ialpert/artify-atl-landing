const cards = [
  {
    ...
    description: "Integrating your apps couldn't be any easier through Installatron.",
    delayAnim: '100',
  },
  {
    id: 2,
    ...
    description: 'Linking your site to your domain name has never been easier with GoDaddy registered domain.',
    delayAnim: '200',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: 'Includes industry-standard cPanel to install apps, manage backups and security.',
    delayAnim: '100',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: 'Get faster page loads & better customer experience with lorem.',
    delayAnim: '300',
  },
];
...
const IncludedPlan = () => {
  return (
    <>
      {cards.map((card) => (
        <div className="col-lg-4 col-sm-6 d-flex" key={card.id} data-aos="fade-up" data-aos-delay={card.delayAnim}>

            ...
            <div className="row align-items-center">
              ...
              >
                <div className="title-style-eight">
                  ...
                  <h2 className="main-title tx-dark fw-bold">{data.mainTitle}</h2>
                </div>
                ...
                {data.buttonLabel !== '' && (
                  ...
                  >
                    ...
                    <img src="/images/icon/icon_69.svg" alt={data.illustrationAlt} className="ms-2" />
                  </Link>
                )}
              </div>
              <div
              ...
              >
                <div className="illustration-holder md-mt-60">
                  <img src={data.illustration} alt={data.illustrationAlt} className="lazy-img" />
                </div>
              </div>
            </div>
          </div>

      ...
      <div className="row">
        <div className="col-xl-5 col-md-6 order-md-last">
          <div className="text-wrapper md-pb-70">
            ...
            <p className="tx-dark pt-30 pb-30 md-pb-15" data-aos="fade-up">
              The team signed <span className="fw-500">~$7,000,000</span> in new business in July. Accelerator has been
              a large part of that.
            </p>
            <h6 className="fs-20 tx-dark d-inline-block fst-italic position-relative ps-4" data-aos="fade-up">
              Jessica Woodbeck
            </h6>
          </div>
          {/* /.text-wrapper */}
        ...
        <div className="col-xl-7 col-md-6 order-md-first" data-aos="fade-up">
          <div className="img-holder d-lg-inline-flex position-relative zn2 pb-45 xl-pb-90">
            <img src="/images/shape/shape_135.svg" alt="shape" className="lazy-img" />
            <Image
              width={561}
              height={732}
              layout="intrinsic"
            ...
            {cardsData.map((item) => (
              <div className={`card-style ${item.cardNo} d-flex justify-content-center`} key={item.id}>

const Pricing = () => {
  ...
  return (
    <>
      <ul className="nav nav-tabs justify-content-center border-0 pricing-nav-one" role="tablist" data-aos="fade-up">
        {tabs.map((tab) => (
      ...
      <div className="pricing-table-area-one mt-110 lg-mt-60 pe-xxl-4 ps-xxl-4" data-aos="fade-up">
                  ...
                  {plans.map((item, index) => (
                    <div className="col-md-4 pr-column sm-mb-20" key={index}>
                      ...
                      <div className="pr-body">
                        <ul className="style-none">
                          {item.features.map((feature) => (
                            <li key={feature.text}>
                              <span className="pr-text d-block d-lg-none mb-5">{feature.text}</span>
                              <i className={feature.available ? 'bi bi-check2 availabe' : 'bi bi-x not-available'} />
                            </li>
                          ))}
                        </ul>
                      </div>
                      <div className="pr-footer">
                        ...
                        <div className="trial-text mt-15 fs-15 opacity-75">Get your 30 day free trial</div>
                      </div>
                    </div>
                  ))}
                </div>

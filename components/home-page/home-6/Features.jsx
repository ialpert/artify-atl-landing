...
const FeatureData = [
  {
    ...
    title: 'File sharing',
    description: 'Our deep understanding of project and program management has enabled the success of our clients.',
  },
  {
    id: 2,
  ...
  return (
    <>
      {FeatureData.map((feature) => (
        <div key={feature.id} className="col-lg-4 col-md-6 mt-40" data-aos="fade-up" data-aos-delay={feature.id * 100}>
          <div className="card-style-three">
            ...
            <Link href="/pages-menu/service-details">
              <img src="/images/icon/icon_18.svg" alt="icon" className="lazy-img" />
            </Link>
          </div>
        </div>
      ))}

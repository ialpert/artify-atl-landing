  ...
  return (
    <div className="fancy-feature-thirty position-relative mt-190 pb-140 lg-mt-100 lg-pb-120 md-p0">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-6 ms-auto">
            <div className="block-style-four ps-xxl-5 ms-xxl-4" data-aos="fade-left">
              <div className="title-style-ten">
                <div className="sc-title">FEATURES</div>
                <h2 className="main-title font-recoleta fw-normal tx-dark">
                  Everything starts with a{' '}
                  <span className="position-relative">
                    Marketing. <img src="/images/shape/shape_122.svg" alt="shape" />
                  </span>
                </h2>
              </div>{' '}
              {/* /.title-style-ten */}
      ...
      <div className="illustration-holder" data-aos="fade-right">
        <img src="/images/media/img_48.png" alt="media" className="lazy-img main-img" />
        <img src="/images/shape/shape_123.svg" alt="media" className="lazy-img shapes shape-one" />
      </div>
    </div>
  );
};

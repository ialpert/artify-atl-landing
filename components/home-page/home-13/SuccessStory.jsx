          ...
          <div className="feedback-block-nine position-relative mt-110">
            ...
            <div className="row">
              <div className="col-lg-5 ms-auto" data-aos="fade-right">
                ...
                <p className="m0">
                  “<span style={{ color: '#00FFFF' }}>Conversation</span> has been a great success with top assured
                  quality.”
                </p>
              </div>
              {/* End .col */}
              <div className="col-lg-5">
                <img src="/images/media/img_51.jpg" alt="img" className="lazy-img img-two " data-aos="fade-up" />
                <img src="/images/shape/shape_128.svg" alt="img" className="lazy-img shapes shape-two" />
              </div>
            </div>
          </div>
        </div>

        <div className="customer-data d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
          <div className="fw-500 tx-dark amount">32k</div>
          <div className="text-lg tx-dark">Customer</div>
        </div>
        {/* /.customer-data */}

        <img src="/images/media/img_52.jpg" alt="img" className="lazy-img img-three" data-aos="fade-up" />
        <img src="/images/shape/shape_127.svg" alt="img" className="lazy-img shapes shape-one" />
      </div>
    </>
  );
};

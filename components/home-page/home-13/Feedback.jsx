const Feedback = () => {
  ...
  return (
    <div className="feedback-section-eight position-relative pt-200 pb-30 lg-pt-120 " data-aos="fade-up">
      <div className="container">
        <img src="/images/icon/icon_92.svg" alt="shape" className="icon lazy-img m-auto" width={75} />
        <div className="row">
              ...
              <div className="item">
                <div className="feedback-block-eight text-center">
                  <p className="font-recoleta tx-dark mt-60 mb-65 lg-mt-40 lg-mb-40">
                    We signed <span>$70b</span> in a new business in January. Most award winninig agency.
                  </p>

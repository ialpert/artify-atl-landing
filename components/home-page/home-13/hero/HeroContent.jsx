  ...
  return (
    <>
      ...
      <p className="sub-text mt-20 mb-45 lg-mb-30">
        ...
        <span className="text-white"> 3x faster</span> revenue than other market.
      </p>
      <div className="d-lg-flex align-items-center">
        <Link href="/contact/contact-v1" className="demo-btn fw-500 tran3s d-inline-flex align-items-center mb-25 me-4">
      ...
      <p className="fs-18 opacity-50 text-white">Avg rating 4.8 makes us world most best apps.</p>
    </>
  );
};

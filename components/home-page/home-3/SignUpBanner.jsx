    ...
    <div className="fancy-feature-fortyFive position-relative zn2 bg-black pt-50 pb-30 mt-150 lg-mt-100">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-lg-5 col-md-6 ms-auto order-md-last" data-aos="fade-left">
            ...
            <p className="fs-20 text-white mb-55 lg-mb-30">
              If you’ve made it this far, you must be at least a little curious. Sign up and take the first step toward
              your goals.
            </p>
          ...
          <div className="col-lg-6 col-md-6 order-md-first" data-aos="fade-right">
            <div className="img-holder zn2 position-relative sm-mt-40">
              ...
              <img src="/images/shape/shape_155.svg" alt="shapes" className="lazy-img shapes shape-one" />
            </div>{' '}
            {/* /.img-holder */}
          </div>
        </div>
      ...
      <img src="/images/shape/shape_156.svg" alt="shapes" className="lazy-img shapes shape-two" />
      <img src="/images/shape/shape_157.svg" alt="shapes" className="lazy-img shapes shape-three" />
    </div>
  );
};

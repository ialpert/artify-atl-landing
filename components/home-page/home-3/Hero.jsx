        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <div className="text-wrapper" data-aos="fade-right">
              <h1 className="hero-heading fw-500 tx-dark">Start learning from our top experts.</h1>
              <p className="text-lg tx-dark mb-30 pt-35 lg-pt-20 lg-mb-20">
                Unlock your potential with unlimited short courses &amp; earn certificates to boost your CV.
              </p>
              <div className="d-lg-flex align-items-center">
                ...
                >
                  ...
                  <img src="/images/icon/icon_123.svg" alt="icon" className="ms-3" />
                </a>
          ...
          <div className="col-xxl-6 col-xl-5 col-md-6 ms-auto text-end" data-aos="fade-left">
            <div className="image-holder zn2 d-inline-block position-relative sm-mt-60">
              <img src="/images/assets/bg-12.png" alt="img" className="lazy-img" />
              ...
              <img src="/images/shape/shape_146.svg" alt="shape" className="shapes shape-one lazy-img" />
              <img src="/images/shape/shape_147.svg" alt="shape" className="shapes shape-two lazy-img" />
            </div>
          </div>
          {/* End col-6 */}
        </div>

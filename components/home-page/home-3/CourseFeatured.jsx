    ...
    <>
      {coursesData.map((course) => (
        <div className="col-sm-6 d-flex flex-column space-fix" key={course.id}>
          <a href="#" className="card-style-nineteen position-relative d-flex flex-column tran3s mb-40 xs-mb-20">
            <span className="tag fw-500 text-white text-uppercase">{course.tag}</span>
            ...
            <span className="tag2 fw-bold tx-dark text-uppercase mt-auto">{course.tag2}</span>
          </a>
          {/* /.card-style-nineteen */}
        </div>
      ))}

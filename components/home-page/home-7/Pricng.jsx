const monthlyPricingPlans = [
  {
    ...
    price: '$13',
    plan: 'Reguler Plan',
    features: ['Unlimited Email', '5gb Hosting & Domain', 'Email & Live chat.', 'Cloud'],
  },
  {
    id: 'flexible',
    price: '$20',
...
const Pricing = () => {
  return (
    <>
      <ul className="nav nav-tabs justify-content-center border-0 pricing-nav-two" data-aos="fade-up" role="tablist">
                ...
                <div className="row gx-xxl-5 align-items-center pricing-table-area-two">
                  {monthlyPricingPlans.map((plan) => (
                    <div key={plan.id} className="col-lg-4 col-sm-6">
                      <div className={`pr-column mt-40 ${plan.active ? 'active' : ''}`}>
                        <div className="pr-header pb-30 mb-45">
                          <div className="price fw-500 tx-dark">{plan.price}</div>
                        ...
                        <div className="pr-footer pt-55 lg-pt-30">
                          <div className="trial-text opacity-75 mb-20">Up to 7 user + 1.99 per user</div>
                          <a href="#" className="signup-btn fw-500 tran3s w-100">
                            Sign up
                          </a>
                        </div>
                      </div>

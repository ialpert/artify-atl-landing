const campaignBlocks = [
  ...
  },
  {
    ...
    subtitle: (
      <>
        Growing up in poverty, children face tough <br /> hunger and malnutrition
      </>
    ),
  },
  {
    ...
    <>
      {campaignBlocks.map((block, index) => (
        ...
        >
          ...
          {block.subtitle && <p className="fs-18 text-center tx-dark">{block.subtitle}</p>}
          <a href="#" className="btn-more rounded-circle text-center fw-light tran3s">
            +
          </a>
        </div>
      ))}

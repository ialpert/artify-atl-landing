    ...
    <div className="row">
      <div className="col-lg-5 col-md-10" data-aos="fade-right">
        <div className="title-style-six pe-xxl-5">
          <h2 className="main-title fw-500 tx-dark">Help us to end poverty for good start with a child.</h2>
        </div>
        {/* /.title-style-six */}
      </div>
      {/* End .col */}
      ...
      <div className="col-lg-6 ms-auto" data-aos="fade-left">
        <p className="m0 sp-text1 fs-20 pb-85 lg-pb-30 md-pt-20">
          ...
          and medical services, social discrimination and isolation. we can end poverty for good.
        </p>

  ...
  const campaigns = [
    {
      ...
      description: 'Lorem ipsum dolor consectetur adipisci. Vivamus in magna tellus fringilla eleifend.',
      aosDelay: '100',
    },
    {
        ...
        <div className="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-delay={campaign.aosDelay} key={index}>
          <div className="card-style-eight mt-40 ">
            <div className="img-meta position-relative">
              <Image width={364} height={282} src={campaign.imgSrc} alt="" className="lazy-img w-100" />

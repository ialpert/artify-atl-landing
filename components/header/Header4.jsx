...
const Header4 = () => {
  ...
  return (
    <header className={`theme-main-menu sticky-menu theme-menu-five charity white-vr ${navbar ? 'fixed' : ''}`}>
      <div className="inner-content position-relative">
        <div className="d-flex align-items-center">
          <div className="logo order-lg-0">
            <Link href="/">
              <Image width={95} height={30} src="/images/logo/logo_02.png" alt="logo" />
            </Link>
          </div>
          {/* End logo */}
          <div className="right-widget d-flex align-items-center ms-auto order-lg-3">
            <Link href="/login" className="call-btn-one d-flex align-items-center me-3">
              <Image width={15} height={15} src="/images/icon/icon_43.svg" alt="icon" className="me-2" />
            ...
            <Link href="/contact" className="donate-btn fw-500 tran3s position-relative d-none d-lg-block">
              Donate Now
            </Link>
          </div>
          {/* /.right-widget */}
